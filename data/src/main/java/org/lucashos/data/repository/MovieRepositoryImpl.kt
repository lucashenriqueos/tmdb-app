...
class MovieRepositoryImpl(private val apiClient: ApiClient, private val movieDao: MovieDao) : MovieRepository {
    ...
    override fun findFavourite(id: Int): Single<Int> =
        movieDao.findFavourite(id)

    override fun addFavourite(id: Int): Single<Any> =
        movieDao.insert(MovieEntity(id)).toSingleDefault(true)

    override fun removeFavourite(id: Int): Single<Int> = movieDao.delete(MovieEntity(id))
